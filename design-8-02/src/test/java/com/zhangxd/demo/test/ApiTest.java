...
import com.zhangxd.demo.design.service.engine.Engine;
import com.zhangxd.demo.design.service.engine.impl.TreeEngineHandle;
...
public class ApiTest {
    ...
    public void test_tree() {
        ...
        Engine treeEngineHandle = new TreeEngineHandle();

        Map<String, String> decisionMatter = new HashMap<>();
        decisionMatter.put("gender", "man");
        decisionMatter.put("age", "24");

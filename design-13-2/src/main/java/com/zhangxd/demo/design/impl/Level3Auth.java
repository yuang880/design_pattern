...
public class Level3Auth extends AuthLink {
    ...
    private Date dateStart = DateUtil.parse("2020-06-01 00:00:00", DatePattern.NORM_DATETIME_FORMAT);

    private Date dateEnd = DateUtil.parse("2020-06-25 23:59:59", DatePattern.NORM_DATETIME_FORMAT);
    ...
    public AuthInfo doAuth(String uId, String orderId, Date authDate) {
        ...
        if (null == next) {
            return new AuthInfo("0000", "单号：", orderId, " 状态：三级审批完成负责人", " 时间：", DateUtil.format(date, DatePattern.NORM_DATETIME_FORMAT), " 审批人：", levelUserName);
        }
